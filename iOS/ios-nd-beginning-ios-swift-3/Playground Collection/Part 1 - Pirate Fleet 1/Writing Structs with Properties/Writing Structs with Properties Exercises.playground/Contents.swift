...
var redFern = Book(title: "Where the Red Fern Grows", author: wilsonRawls, pages: 245, numberOfStars: 4, description: "This book is about a young boy and his hunting dogs", genre: "Children's Book")

var jrrTolkien = Author(firstName: "JRR", lastName: "Tolkien", living: false)
var theHobbit = Book(title: "The Hobbit", author: jrrTolkien, pages: 300, numberOfStars: 4.5, description: "The Hobbit follows the treasure-seeking quest of hobbit Bilbo Baggins.", genre: "Fantasy")

var maryShelley = Author(firstName: "Mary", lastName: "Shelley", living: false)
var frankenstein = Book(title: "Frankenstein", author: maryShelley, pages: 280, numberOfStars: 4.7, description: "Frankenstein is about a young science student named Victor Frankenstein who creates a sentient creature in an unorthodox scientific experiment.", genre: "Gothic")
